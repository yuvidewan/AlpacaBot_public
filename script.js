// Fixed avatar path, backend URL detection and error handling
const form = document.getElementById('chat-form');
const chatBox = document.getElementById('chat-box');
const userInput = document.getElementById('user-input');
const databaseSelect = document.getElementById('database-select');

// Default avatars that will work in deployment
...
// Determine the API URL based on the current deployment
const getApiUrl = () => {
    // In production, use the same origin; in development, use localhost:5000
